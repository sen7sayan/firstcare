                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-md-3 cols-sm-2 cols-1">
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content">
                                        ...
                                        <p><a href="mailto:help.shop24u@gmail.com" >help.shop24u@gmail.com</a></p>
                                    </div>
                                </div>
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                ...
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content">
                                        <h4 class="icon-box-title">Office Address</h4>
                                        <p>Office : 36/2, Vivekananda Road, 5th Floor, Near Haryana Bhawan, Girish Park,
Kolkata - 700007</p>
                                    </div>
                                </div>
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content">
                                        <h4 class="icon-box-title">Godown </h4>
                                        <p>4, Biplabi Anukul Chandra Street Gr Floor, Near Sabir's Hotel, Chandni Chowk, Kolkata - 700072</p>
                                    </div>
                                </div>
                            </div>
                    </section>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3684.3231750713817!2d88.35325317475693!3d22.567013133176037!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a02777090bc40a3%3A0x4f2dde35542d5e4b!2sShop24u.com!5e0!3m2!1sen!2sin!4v1721849581729!5m2!1sen!2sin" style="width:100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <!-- End of PageContent -->
        </main>
        <!-- End of Main -->
