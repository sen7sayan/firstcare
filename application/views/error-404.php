        ...
        <main class="main">
            ...
            <div class="page-content error-404">
                <div class="container">
                    <div class="banner">
                        <figure>
                            <img src="<?= base_url()?>assets/images/pages/404.png" alt="Error 404"  
                        ...
                        <div class="banner-content text-center">
                            ...
                            <a href="<?= base_url('collection')?>" class="btn btn-dark btn-rounded btn-icon-right">Go Back Home<i class="w-icon-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
