...
<div class="col-md-10 px-4">
    ...
    <div class="row">
        ...
        <div class="col-md-10 p-2 ">
            <!-- add new cat -->
            <a href="<?= base_url('index.php/admin/pageList')?>" class="btn btn-success btn-sm float-right" >All Pages</a>
            <!-- add new cat -->
            <br><hr>
            <div class="card">
                <div class="card-body p-3">
                   <form action="<?= base_url('index.php/admin/add_new_page_data')?>" method="post" >
                    
                     <div class="row">
                        <div class="col-md-12 px-2">
                            <div class="form-group">
                                <label for="catname">Page name</label>
                                <input type="text" name="pagename" id="catname" class="form-control" placeholder="Enter Category name" required >
                            </div>
                        </div>
                        <div class="col-md-12 px-2">
                            <div class="form-group">
                                <label for="catname">Page Url(Ex: this-is-page-url/ this is page url)</label>
                                <input type="text" name="pageurl" id="catname" class="form-control" placeholder="Enter Category name" required >
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="categoryDetails">Page Content</label>
                                <textarea class="form-control" row="5" name="pageContent" id="categoryDetails"></textarea>
                            </div>
